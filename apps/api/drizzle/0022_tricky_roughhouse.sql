CREATE TABLE "system_provider_keys" (
	...
	CONSTRAINT "system_provider_keys_secret_complete" CHECK (("system_provider_keys"."ciphertext" is null and "system_provider_keys"."iv" is null and "system_provider_keys"."auth_tag" is null)
          or ("system_provider_keys"."ciphertext" is not null and "system_provider_keys"."iv" is not null and "system_provider_keys"."auth_tag" is not null))
);
