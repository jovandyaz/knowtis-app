...
- getNote returns the note body as Markdown. When you propose an update, reproduce everything the user did not ask you to change exactly as getNote returned it — same links, same headings, same emphasis — and change only what was asked.`;
