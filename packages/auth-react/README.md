...
- **Query hooks:** `authQueryKeys`, `useProfile()`, `useLogin()`, `useRegister()`, `useLogout()`, `useForgotPassword()`, `useResetPassword()`, `useVerifyEmail()`, `useVerifyEmailCode()`, `useResendVerification()`
