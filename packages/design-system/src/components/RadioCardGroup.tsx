    ...
    >
      {options.map(({ value: optionValue, title, description, icon: Icon }) => (
        <ToggleGroupPrimitive.Item
          ...
          value={optionValue}
          className={cn(
            'flex w-full cursor-pointer items-start gap-3 rounded-lg border-2 p-3 text-left transition-all duration-(--motion-duration-fast) ease-standard motion-reduce:transition-none',
