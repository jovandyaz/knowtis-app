...
import { AUTH_ERROR_STATUS_MAP } from '../auth-error-status-map';

describe('AUTH_ERROR_STATUS_MAP', () => {
  it('pins the HTTP status every auth domain error answers with', () => {
    expect(AUTH_ERROR_STATUS_MAP).toEqual({
